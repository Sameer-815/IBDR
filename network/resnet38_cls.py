...
class Net(network.resnet38d.Net):
    ...
    def forward(self, x):
        x1, x2, x, boundary_pred, embedding = super().forward(x)  #[16,512,28,28],[16,1024,28,28],[16,4096,28,28]
        x1 = self.ic1(x1)
        x2 = self.ic2(x2)
        ...
        return x1, x2, x, feature, y, boundary_pred, embedding
...
class Net_CAM(network.resnet38d.Net):
    ...
    def forward_cam(self, x):
        x1, x2, x_, boundary_pred, embedding = super().forward(x)
        '''b4_5'''
